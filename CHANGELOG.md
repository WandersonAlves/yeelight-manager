...
### [0.1.1-preview.9](https://github.com/WandersonAlves/yeelight-manager/compare/v0.1.1-preview.8...v0.1.1-preview.9) (2023-08-22)


### Bug Fixes

* load yee version using version.ts ([e8199a9](https://github.com/WandersonAlves/yeelight-manager/commit/e8199a9ef161508ae6deeed3f06cfe032a1e4d24))
...
* add [@all](https://github.com/all) alias when calling ReceiveCommand ([3d3da1b](https://github.com/WandersonAlves/yeelight-manager/commit/3d3da1bebcebb3d0d24593c409c9d92b77bd1552))
* add black pallete verification ([5809dc3](https://github.com/WandersonAlves/yeelight-manager/commit/5809dc3f3386243a9384a09de6c0fbcd8d3d906f))
* add color interpolation and factor to color.rs ([ecc6956](https://github.com/WandersonAlves/yeelight-manager/commit/ecc69567bcfe1e5f6d7d369f969918289b863cb8))
* add default values to ct cmd ([9072e02](https://github.com/WandersonAlves/yeelight-manager/commit/9072e02b8f3c7639e8d00376f7d11be8ee1dbcac))
* add napi-rs with color solution in rust ([5a0abe7](https://github.com/WandersonAlves/yeelight-manager/commit/5a0abe7251d9e7d1770b0ad681d7921c8d7b8ccf))
* add option to not use luminance variation on ambilight ([16fd5a6](https://github.com/WandersonAlves/yeelight-manager/commit/16fd5a64d82e87abe2f6301e8596d60373d26d4d))
* ambilight stable :rocket: using Rust to fetch colors ([ed62e56](https://github.com/WandersonAlves/yeelight-manager/commit/ed62e56d5345584b73b5212efe5d67e341374b64))
* better commands help ([cbc60a3](https://github.com/WandersonAlves/yeelight-manager/commit/cbc60a368a0c639385b01762fe6b18a115929700))
* better error handling on ReceiveCommandCase ([c6af05d](https://github.com/WandersonAlves/yeelight-manager/commit/c6af05dcdc830b39f689c8c96c6f02054ae42771))
* change color provider to nut-js ([34cb556](https://github.com/WandersonAlves/yeelight-manager/commit/34cb55616777c22bdc10eae0d14fd175ac28f204))
* more stability when handling commands ([6df1da5](https://github.com/WandersonAlves/yeelight-manager/commit/6df1da55ed9e6d90caf232033677a7ae87637ffb))
* spawn ambilight worker on another thread ([1228323](https://github.com/WandersonAlves/yeelight-manager/commit/1228323928de6872f649bb2bb4483c6a77ba95cd))
* use rust to get color ([09c77a6](https://github.com/WandersonAlves/yeelight-manager/commit/09c77a684c3e810439907006c993ae65fbf8025a))
* **wip:** ambilight stable ([0c0885f](https://github.com/WandersonAlves/yeelight-manager/commit/0c0885ff449f178ed9a9e50ec8a90dfe63d185a3))


### Bug Fixes

* better box sizing on GetScreenAreaDimensions ([efef5c0](https://github.com/WandersonAlves/yeelight-manager/commit/efef5c057368a13f86d8f37b511b7324ccaed6f3))
* better error handling on amblight files ([60f3138](https://github.com/WandersonAlves/yeelight-manager/commit/60f31380f53b2ca4d9c3bba861e383fdac20cfb7))
* better path on tsconfig.include ([9d30202](https://github.com/WandersonAlves/yeelight-manager/commit/9d30202a2a6e028d6933b8eaa027d0a0ee37a4a4))
* better setx handle ([e32678f](https://github.com/WandersonAlves/yeelight-manager/commit/e32678fbccd106121b822ef0ebf867d7acf6e5e8))
* check array before enter it ([f57d703](https://github.com/WandersonAlves/yeelight-manager/commit/f57d703f8eb48730225b767c7d1ca2fab498f16f))
* don't crash if cant parse json ([a32ebe3](https://github.com/WandersonAlves/yeelight-manager/commit/a32ebe37a41ed318e151b6ab3ba671216c55db18))
* error when devices not found ([67fe587](https://github.com/WandersonAlves/yeelight-manager/commit/67fe5874a66c93201ff9e71f44a33077cfd169f7))
* expose Command.id ([20c5c8f](https://github.com/WandersonAlves/yeelight-manager/commit/20c5c8f8c0a79e91fd1483a73488089434db5a49))
* filter devices already on when turnOnAll ([3a92ea2](https://github.com/WandersonAlves/yeelight-manager/commit/3a92ea28b04d6e71557e2b8cfd658e67d4e2b5be))
* only show devices on `yee list` ([cc035e8](https://github.com/WandersonAlves/yeelight-manager/commit/cc035e8c3175b7b0e1f85c7b6ca0a09ae9f75b7b))
* rust artifact on .gitignore ([ba02045](https://github.com/WandersonAlves/yeelight-manager/commit/ba020459bacc5f80df14140d2ba4fa8dafbcf373))
* unnecessary new client on connect ([2e15dc7](https://github.com/WandersonAlves/yeelight-manager/commit/2e15dc7399e71b5dc42dc70c5cdddd493790c54b))
